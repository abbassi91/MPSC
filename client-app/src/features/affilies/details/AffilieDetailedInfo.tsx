...
import { Grid, Tab, Button, Table, Header, Image, Card, Icon } from 'semantic-ui-react';
...
const AffilieDetailedInfo: React.FC<RouteComponentProps<DetailParams>> = ({  match,
  history }) => {
  ...
  if (loadingInitial) return <LoadingComponent content='Loading affilie...' />;
...
export default AffilieDetailedInfo;
