        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.topContaint}>
                    <Text style={styles.top}>Dossiers Payés + (SUIVIS DES AVANCES)</Text>
                ...
                <View style={styles.title}>
                    <Text style={styles.Titre2} >Dossiers Payés</Text>
                </View>
                ...
                </View>) : (<View style={styles.row} key={qp.nDossier} wrap={false}>
                    <Text style={styles.columnTableMed}>{qp.nDossier}</Text>
                    <Text style={styles.columnTableMed}>{format(qp.datePaiementReel, 'dd/MM/yyyy', { locale: local })}</Text>
                    <Text style={styles.columnTableMed}>{qp.fraisEngage}</Text>
                    <Text style={styles.columnTableMed}>{qp.rembAmo} </Text>
                    <Text style={styles.columnTableMed}>{qp.rembMpsc} </Text>
                    <Text style={styles.columnTableMed}>{qp.totalRemb} </Text>
                    <Text style={styles.columnTableMed}>{qp.observation} </Text>
                ...
                <View style={styles.rowFooter}  wrap={false}>
                    <Text style={styles.columnVide}>Sous Totaux.Dossiers Individuels (DI) </Text>
                    <Text style={styles.Tablefooter}>{affilie.somFreEngageDI} Dhs</Text>
                    <Text style={styles.Tablefooter}>{affilie.somRemCnopsDI} Dhs</Text>
                    <Text style={styles.Tablefooter}>{affilie.somRemMpscDI} Dhs</Text>
                    <Text style={styles.Tablefooter}>{affilie.somRemDI} Dhs</Text>
                </View>
                <View style={styles.rowFooter}  wrap={false}>
                    <Text style={styles.columnVide}>Sous Totaux DI + TP </Text>
                    <Text style={styles.Tablefooter}>{affilie.somFreEngage} Dhs</Text>
                    <Text style={styles.Tablefooter}>{affilie.somRemCnops} Dhs</Text>
                    <Text style={styles.Tablefooter}>{affilie.somRemMpsc} Dhs</Text>
                    <Text style={styles.Tablefooter}>{affilie.somRem} Dhs</Text>
                </View>
                <View style={styles.rowFooter}  wrap={false}>
